...
impl<T: Bus> Core<T> {
    ...
    fn dispatch<const E: bool, const M: bool, const X: bool>(&mut self) {
        ...
        match self.next_byte() {
            ...
            //0x64 => instr::read::<addr::Direct, op::Nop>(self),
            //0x84 => instr::write::<addr::Direct, op::Sty>(self),
            //0xa4 => instr::read::<addr::Direct, op::Ldy>(self),
            //0xc4 => instr::read::<addr::Direct, op::Cpy>(self),
            //0xe4 => instr::read::<addr::Direct, op::Cpx>(self),

            // +0x14
            //0x14 => instr::read::<addr::DirectX, op::Nop>(self),
            //0x34 => instr::read::<addr::DirectX, op::Nop>(self),
            //0x54 => instr::read::<addr::DirectX, op::Nop>(self),
            //0x74 => instr::read::<addr::DirectX, op::Nop>(self),
            //0x94 => instr::write::<addr::DirectX, op::Sty>(self),
            //0xb4 => instr::read::<addr::DirectX, op::Ldy>(self),
            //0xd4 => instr::read::<addr::DirectX, op::Nop>(self),
            //0xf4 => instr::read::<addr::DirectX, op::Nop>(self),
            ...
            // +0x15
            //0x15 => instr::read::<addr::DirectX, op::Ora>(self),
            //0x35 => instr::read::<addr::DirectX, op::And>(self),
            //0x55 => instr::read::<addr::DirectX, op::Eor>(self),
            //0x75 => instr::read::<addr::DirectX, op::Adc>(self),
            //0x95 => instr::write::<addr::DirectX, op::Sta>(self),
            //0xb5 => instr::read::<addr::DirectX, op::Lda>(self),
            //0xd5 => instr::read::<addr::DirectX, op::Cmp>(self),
            //0xf5 => instr::read::<addr::DirectX, op::Sbc>(self),
            ...
            // +0x06
            //0x06 => instr::modify::<addr::Direct, op::Asl>(self),
            //0x26 => instr::modify::<addr::Direct, op::Rol>(self),
            //0x46 => instr::modify::<addr::Direct, op::Lsr>(self),
            //0x66 => instr::modify::<addr::Direct, op::Ror>(self),
            //0x86 => instr::write::<addr::Direct, op::Stx>(self),
            //0xa6 => instr::read::<addr::Direct, op::Ldx>(self),
            //0xc6 => instr::modify::<addr::Direct, op::Dec>(self),
            //0xe6 => instr::modify::<addr::Direct, op::Inc>(self),

            // +0x16
            //0x16 => instr::modify::<addr::DirectX, op::Asl>(self),
            //0x36 => instr::modify::<addr::DirectX, op::Rol>(self),
            //0x56 => instr::modify::<addr::DirectX, op::Lsr>(self),
            //0x76 => instr::modify::<addr::DirectX, op::Ror>(self),
            //0x96 => instr::write::<addr::DirectY, op::Stx>(self),
            //0xb6 => instr::read::<addr::DirectY, op::Ldx>(self),
            //0xd6 => instr::modify::<addr::DirectX, op::Dec>(self),
