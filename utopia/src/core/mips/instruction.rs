...
pub fn dispatch<T: Bus>(core: &mut Core<T>, word: u32) {
    ...
    match word >> 26 {
        ...
        0o20 => T::Cp0::dispatch(core, word),
        0o21 => {
            debug_assert!(T::CP1);
            cp1::cop1(core, word);
        }
        0o22 => T::Cp2::dispatch(core, word),
...
fn special(core: &mut Core<impl Bus>, word: u32) {
    match word & 0o77 {
        ...
        0o30 => type_r(core, mult, word),
        0o31 => type_r(core, multu, word),
        0o32 => type_r(core, div, word),
        0o33 => type_r(core, divu, word),
        0o34 => type_r(core, dmult, word),
        0o35 => type_r(core, dmultu, word),
        0o36 => type_r(core, ddiv, word),
        ...
        0o54 => type_r(core, dadd, word),
        0o55 => type_r(core, daddu, word),
        0o56 => type_r(core, dsub, word),
        0o57 => type_r(core, dsubu, word),
