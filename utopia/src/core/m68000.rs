...
impl<T: Bus> Core<T> {
    ...
    pub fn step(&mut self) {
        ...
        match word >> 6 {
            ...
            | 0b0101_1010_00 | 0b0101_1100_00 | 0b0101_1110_00 => {
                instr::quick::<op::Add, u8>(self, word)
            }
            0b0101_0000_01 | 0b0101_0010_01 | 0b0101_0100_01 | 0b0101_0110_01 | 0b0101_1000_01
            | 0b0101_1010_01 | 0b0101_1100_01 | 0b0101_1110_01 => {
                instr::quick::<op::Add, u16>(self, word)
            }
            0b0101_0000_10 | 0b0101_0010_10 | 0b0101_0100_10 | 0b0101_0110_10 | 0b0101_1000_10
            | 0b0101_1010_10 | 0b0101_1100_10 | 0b0101_1110_10 => {
                instr::quick::<op::Add, u32>(self, word)
            }

            0b0101_0001_00 | 0b0101_0011_00 | 0b0101_0101_00 | 0b0101_0111_00 | 0b0101_1001_00
            | 0b0101_1011_00 | 0b0101_1101_00 | 0b0101_1111_00 => {
                instr::quick::<op::Sub, u8>(self, word)
            }
            0b0101_0001_01 | 0b0101_0011_01 | 0b0101_0101_01 | 0b0101_0111_01 | 0b0101_1001_01
            | 0b0101_1011_01 | 0b0101_1101_01 | 0b0101_1111_01 => {
                instr::quick::<op::Sub, u16>(self, word)
            }
            0b0101_0001_10 | 0b0101_0011_10 | 0b0101_0101_10 | 0b0101_0111_10 | 0b0101_1001_10
            | 0b0101_1011_10 | 0b0101_1101_10 | 0b0101_1111_10 => {
                instr::quick::<op::Sub, u32>(self, word)
            }
            ...
            // Shifts and rotates
            0b1110_0000_00 | 0b1110_0010_00 | 0b1110_0100_00 | 0b1110_0110_00 | 0b1110_1000_00
            | 0b1110_1010_00 | 0b1110_1100_00 | 0b1110_1110_00 => {
                instr::shift_many_right::<u8>(self, word)
            }
            0b1110_0000_01 | 0b1110_0010_01 | 0b1110_0100_01 | 0b1110_0110_01 | 0b1110_1000_01
            | 0b1110_1010_01 | 0b1110_1100_01 | 0b1110_1110_01 => {
                instr::shift_many_right::<u16>(self, word)
            }
            0b1110_0000_10 | 0b1110_0010_10 | 0b1110_0100_10 | 0b1110_0110_10 | 0b1110_1000_10
            | 0b1110_1010_10 | 0b1110_1100_10 | 0b1110_1110_10 => {
