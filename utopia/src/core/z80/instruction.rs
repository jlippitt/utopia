...
pub fn dispatch(core: &mut Core<impl Bus>) {
    ...
    match core.fetch() {
        ...
        // +0x01 / +0x09
        0x01 => load::ld16::<addr::BC>(core),
        0x09 => alu::add16::<addr::BC>(core),
        0x11 => load::ld16::<addr::DE>(core),
        0x19 => alu::add16::<addr::DE>(core),
        0x21 => load::ld16::<addr::HL>(core),
        0x29 => alu::add16::<addr::HL>(core),
        0x31 => load::ld16::<addr::SP>(core),
        0x39 => alu::add16::<addr::SP>(core),

        // +0x02 / +0x0a
        0x02 => load::ld::<addr::BCIndirect, addr::A>(core),
        0x0a => load::ld::<addr::A, addr::BCIndirect>(core),
        0x12 => load::ld::<addr::DEIndirect, addr::A>(core),
        0x1a => load::ld::<addr::A, addr::DEIndirect>(core),
        // 0x22 => instr::ld::<addr::HLIncrement, addr::A>(core),
        // 0x2a => instr::ld::<addr::A, addr::HLIncrement>(core),
        // 0x32 => instr::ld::<addr::HLDecrement, addr::A>(core),
        // 0x3a => instr::ld::<addr::A, addr::HLDecrement>(core),
        ...
        // +0x06 / +0x0e
        0x06 => load::ld::<addr::B, addr::Immediate>(core),
        0x0e => load::ld::<addr::C, addr::Immediate>(core),
        0x16 => load::ld::<addr::D, addr::Immediate>(core),
        0x1e => load::ld::<addr::E, addr::Immediate>(core),
        0x26 => load::ld::<addr::H, addr::Immediate>(core),
        0x2e => load::ld::<addr::L, addr::Immediate>(core),
        0x36 => load::ld::<addr::HLIndirect, addr::Immediate>(core),
        0x3e => load::ld::<addr::A, addr::Immediate>(core),
        ...
        // 0x40
        0x40 => load::ld::<addr::B, addr::B>(core),
        0x41 => load::ld::<addr::B, addr::C>(core),
        0x42 => load::ld::<addr::B, addr::D>(core),
        0x43 => load::ld::<addr::B, addr::E>(core),
        0x44 => load::ld::<addr::B, addr::H>(core),
        0x45 => load::ld::<addr::B, addr::L>(core),
        0x46 => load::ld::<addr::B, addr::HLIndirect>(core),
        0x47 => load::ld::<addr::B, addr::A>(core),

        // 0x48
        0x48 => load::ld::<addr::C, addr::B>(core),
        0x49 => load::ld::<addr::C, addr::C>(core),
        0x4a => load::ld::<addr::C, addr::D>(core),
        0x4b => load::ld::<addr::C, addr::E>(core),
        0x4c => load::ld::<addr::C, addr::H>(core),
        0x4d => load::ld::<addr::C, addr::L>(core),
        0x4e => load::ld::<addr::C, addr::HLIndirect>(core),
        0x4f => load::ld::<addr::C, addr::A>(core),

        // 0x50
        0x50 => load::ld::<addr::D, addr::B>(core),
        0x51 => load::ld::<addr::D, addr::C>(core),
        0x52 => load::ld::<addr::D, addr::D>(core),
        0x53 => load::ld::<addr::D, addr::E>(core),
        0x54 => load::ld::<addr::D, addr::H>(core),
        0x55 => load::ld::<addr::D, addr::L>(core),
        0x56 => load::ld::<addr::D, addr::HLIndirect>(core),
        0x57 => load::ld::<addr::D, addr::A>(core),

        // 0x58
        0x58 => load::ld::<addr::E, addr::B>(core),
        0x59 => load::ld::<addr::E, addr::C>(core),
        0x5a => load::ld::<addr::E, addr::D>(core),
        0x5b => load::ld::<addr::E, addr::E>(core),
        0x5c => load::ld::<addr::E, addr::H>(core),
        0x5d => load::ld::<addr::E, addr::L>(core),
        0x5e => load::ld::<addr::E, addr::HLIndirect>(core),
        0x5f => load::ld::<addr::E, addr::A>(core),

        // 0x60
        0x60 => load::ld::<addr::H, addr::B>(core),
        0x61 => load::ld::<addr::H, addr::C>(core),
        0x62 => load::ld::<addr::H, addr::D>(core),
        0x63 => load::ld::<addr::H, addr::E>(core),
        0x64 => load::ld::<addr::H, addr::H>(core),
        0x65 => load::ld::<addr::H, addr::L>(core),
        0x66 => load::ld::<addr::H, addr::HLIndirect>(core),
        0x67 => load::ld::<addr::H, addr::A>(core),

        // 0x68
        0x68 => load::ld::<addr::L, addr::B>(core),
        0x69 => load::ld::<addr::L, addr::C>(core),
        0x6a => load::ld::<addr::L, addr::D>(core),
        0x6b => load::ld::<addr::L, addr::E>(core),
        0x6c => load::ld::<addr::L, addr::H>(core),
        0x6d => load::ld::<addr::L, addr::L>(core),
        0x6e => load::ld::<addr::L, addr::HLIndirect>(core),
        0x6f => load::ld::<addr::L, addr::A>(core),

        // 0x70
        0x70 => load::ld::<addr::HLIndirect, addr::B>(core),
        0x71 => load::ld::<addr::HLIndirect, addr::C>(core),
        0x72 => load::ld::<addr::HLIndirect, addr::D>(core),
        0x73 => load::ld::<addr::HLIndirect, addr::E>(core),
        0x74 => load::ld::<addr::HLIndirect, addr::H>(core),
        0x75 => load::ld::<addr::HLIndirect, addr::L>(core),
        0x76 => misc::halt(core),
        0x77 => load::ld::<addr::HLIndirect, addr::A>(core),

        // 0x78
        0x78 => load::ld::<addr::A, addr::B>(core),
        0x79 => load::ld::<addr::A, addr::C>(core),
        0x7a => load::ld::<addr::A, addr::D>(core),
        0x7b => load::ld::<addr::A, addr::E>(core),
        0x7c => load::ld::<addr::A, addr::H>(core),
        0x7d => load::ld::<addr::A, addr::L>(core),
        0x7e => load::ld::<addr::A, addr::HLIndirect>(core),
        0x7f => load::ld::<addr::A, addr::A>(core),
        ...
        //0xe0 => instr::ld::<addr::High, addr::A>(core),
        //0xe8 => instr::add_sp_i8(core),
        //0xf0 => instr::ld::<addr::A, addr::High>(core),
        ...
        // 0xe2 => instr::ld::<addr::CIndirect, addr::A>(core),
        // 0xea => instr::ld::<addr::Absolute, addr::A>(core),
        // 0xf2 => instr::ld::<addr::A, addr::CIndirect>(core),
        // 0xfa => instr::ld::<addr::A, addr::Absolute>(core),
